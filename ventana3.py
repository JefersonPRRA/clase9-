...
from PyQt5.QtWidgets import QLabel, QDesktopWidget, QMainWindow, QVBoxLayout, QScrollArea, QTableWidget, \
...
class Ventana3(QMainWindow):
    ...
    def __init__(self,parent=None):
        ...
        # Ponemos el icono
        self.setWindowIcon(QtGui.QIcon('imagenes/arca.jpg'))
        ...
        self.imagenFondo = QPixmap('imagenes/arcangel3.jpg')
